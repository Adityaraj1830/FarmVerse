...
public class FarmCropReport {
    ...
    public FarmCropReport(Long farmId, String farmName, String soil,
            String cropId, String cropName, Double cropArea,
            String sownMonthYear, String harvestMonthYear, Double yield,
            Double water, Double fertilizer, Double pesticides,
            Double tractorHour, Double agroTools,
            Double waterExp, Double fertilizerExp, Double pesticidesExp,
            Double tractorExp, Double agroToolsExp, Double total) {
    ...
    public FarmCropReport(Farm farm, Crop crop, CropInputs inputs,
            CropExpense expense, Double total) {
